...
//        Gerente g1 = new Gerente("Gerente Beltrano", "333.333.333-33", "xyz");
        ...
        Cliente c1 = new Cliente("João da Silva", "1", "1", sistema);
        Cliente c2 = new Cliente("Danilo", "4", "4", sistema);
        Caixa caixa1 = new Caixa("Caixa Fulano", "2", "2", sistema);
        Gerente g1 = new Gerente("Gerente Beltrano", "3", "3", sistema);
        ...
        Conta contaJoao = new Conta("0001", 1000.0, c1.getId());
        Conta contaDanilo = new Conta("0002", 1000.0, c2.getId());
        sistema.adicionarConta(contaJoao);
        sistema.adicionarConta(contaDanilo);
